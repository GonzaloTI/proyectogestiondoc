...
@section('content')
<a href="{{route('admin.listarAsistencia')}}" class="btn btn-primary m-4">Atras</a>


<div class="block mx-auto my-12 p-8 bg-white w-1/3 borderr border-gray-200 rounded-lg shadow-lg">
<h1 class="text-3xl text-center font-bold">Crear Caso de Asistencia Familiar</h1>

<form class="mt-4" method="POST" action="{{route('admin.storedAsistencia')}}">
    @csrf
